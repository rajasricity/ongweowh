...
//						$ff["flocation"] = ["id"=>(string) $flocdata->_id,"locname"=>$flocdata->locname,"loccode"=>$flocdata->loccode,"status"=>$flocdata->status];
						...
						if(count($flocdata) > 0){
							$ff["flocation"] = ["id"=>(string) $flocdata[0]->_id,"locname"=>$flocdata[0]->locname,"loccode"=>$flocdata[0]->loccode,"status"=>$flocdata[0]->status,"flag"=>"excel"];
						...
						if(count($tlocdata[0]) > 0){
							$ff["tlcoation"] = ["id"=>(string) $tlocdata[0]->_id,"locname"=>$tlocdata[0]->locname,"loccode"=>$tlocdata[0]->loccode,"status"=>$tlocdata[0]->status,"flag"=>"excel"];
							$ff['tlocationcode'] = $tlocdata[0]->loccode;
						}else{
							$ff["tlcoation"] = ["id"=>"","locname"=>$ff["tlcoation"],"loccode"=>$ff["tlocationcode"],"status"=>"Active","flag"=>"excel"];
