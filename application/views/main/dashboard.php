...
$user = $this->admin->getRow($mng,['email'=>$this->session->userdata('admin_email')],[],"$mongodb.tbl_auths");
				...
				?>
				  ...
				  <div class="card">
					<div class="card-header">
					  <a class="card-link" data-toggle="collapse" style="color: white;" href="#collapse<? echo $id ?>">
						<? echo $item->item_name ?>
					  </a>
					</div>
