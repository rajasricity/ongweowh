...
<!--                                    <h4 class="page-title">Form Advanced</h4>-->
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="<? echo base_url('user/userdashboard') ?>">Dashboard</a></li>
...
<!--                                                        <td><? //echo $ud["status"] ?></td>-->
                                                        <td>
                                                        	...
                                                        	<a href="#<? //echo base_url('admin/locations/editLocation/').$ud["_id"]->{'$id'} ?>"><i class="far fa-eye"></i></a>
