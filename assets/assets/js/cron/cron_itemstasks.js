	...
	// when condition script starts
		...
		$(".lgetColumn").on("change",function(){
			...
			$.ajax({
				...
				dataType : 'json',
				data : {column : column,table:"tbl_items","onchangeColref":"onchangeCondition","uopid":uopid},
...
//					console.log(data);
		...
		$(document).on("change",".ulgetColumn",function(){
			...
			$.ajax({
				...
				url : base_url+"admin/tasks/getDatatypeconditions",
				dataType : 'json',
				data : {column : column,table:"tbl_items","onchangeColref":"uoperatorchange","uopid":uopid},
				success : function(data){
...
//						console.log(data);
				...
				dataType : 'json',
				data : {column : column,table:"tbl_items"},
				success : function(data){
...
//					console.log(data);
		...
		$(document).on("change",".eulgetColumn",function(){
			...
			$.ajax({
				...
				url : base_url+"admin/tasks/getDatatypeconditions",
				dataType : 'json',
				data : {column : column,table:"tbl_items","onchangeColref":"updateonchangeoperator",uopid:uopid},
				success : function(data){
