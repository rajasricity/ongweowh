	...
	// when condition script starts
		...
		$(document).on("change",".valLabels",function(){
			...
			$.ajax({
				...
				dataType : 'json',
				data : {column : column,table:"tbl_touts","onchangeColref":"onchangevrulesCondition","uopid":uopid,"rCount":rCount},
				success : function(data){
...
//					console.log(data);
		...
		$(document).on("change",".uvalLabels",function(){
			...
			$.ajax({
				...
				url : base_url+"admin/tasks/getDatatypeconditions",
				dataType : 'json',
				data : {column : column,table:"tbl_touts","onchangeColref":"voperatorCh","uopid":uopid,"rCount":rCount},
				success : function(data){
...
//					console.log(data);
	...
	$(document).on("change",".changeLabelArule",function(){
		...
		$.ajax({
			...
			url : base_url+"admin/tasks/getDatatypeconditions",
			dataType : 'json',
			data : {column : column,table:"tbl_touts","onchangeColref":"changeOperatorArule","uopid":uopid,"rCount":rCount},
			success : function(data){
...
// create task
	...
	$("#cvalidationRules").submit(function(e){
