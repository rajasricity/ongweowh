	...
	// when condition script starts
		...
		$(".lgetColumn").on("change",function(){
			...
			$.ajax({
				...
				dataType : 'json',
				data : {column : column,table:"tbl_returns","onchangeColref":"onchangeCondition","uopid":uopid},
...
//					console.log(data);
		...
		$(document).on("change",".ulgetColumn",function(){
			...
			$.ajax({
				...
				url : base_url+"admin/tasks/getDatatypeconditions",
				dataType : 'json',
				data : {column : column,table:"tbl_returns","onchangeColref":"uoperatorchange","uopid":uopid},
				success : function(data){
...
//						console.log(data);
				...
				dataType : 'json',
				data : {column : column,table:"tbl_returns"},
				success : function(data){
...
//    ***************************   Task Update script  ************************************ //
	...
	$(document).on("click",".editTask",function(){
		...
		$.ajax({
			...
			type : "post",
			data : {tid : tid,'table':'tbl_returns'},
...
//					console.log(data);
		...
		$(document).on("change",".eulgetColumn",function(){
			...
			$.ajax({
				...
				url : base_url+"admin/tasks/getDatatypeconditions",
				dataType : 'json',
				data : {column : column,table:"tbl_returns","onchangeColref":"updateonchangeoperator",uopid:uopid},
				success : function(data){
...
//				if(x1 < maxField){
					...
					$.ajax({
						...
						type : "post",
						data : {table:"tbl_returns",toutref:"dshipperpo"},
						dataType : 'json',
						url : base_url+"admin/tasks/getColumns",
						success : function(data){
