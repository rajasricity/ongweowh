	...
	// when condition script starts
		...
		$(".lgetColumn").on("change",function(){
			...
			$.ajax({
				...
				dataType : 'json',
				data : {column : column,table:"tbl_touts","onchangeColref":"onchangeCondition","uopid":uopid},
...
//					console.log(data);
		...
		$(document).on("change",".ulgetColumn",function(){
			...
			$.ajax({
				...
				url : base_url+"admin/tasks/getDatatypeconditions",
				dataType : 'json',
				data : {column : column,table:"tbl_touts","onchangeColref":"uoperatorchange","uopid":uopid},
				success : function(data){
			...
			$(document).on("click",".eaddtask_set",function(){
				...
				if(x1 < maxField){
					...
					$.ajax({
						...
						type : "post",
						data : {table:"tbl_touts",toutref:"dshipperpo"},
						dataType : 'json',
						url : base_url+"admin/tasks/getColumns",
						success : function(data){
...
//						console.log(data);
				...
				dataType : 'json',
				data : {column : column,table:"tbl_touts"},
				success : function(data){
	...
	$(document).on("click",".editTask",function(){
		...
		$.ajax({
			...
			success : function(data){
				...
				$('#etnext_run_time').append($('<option selected>').val(data.next_run_time).text(data.next_run_time));
...
//					console.log(data);
		...
		$(document).on("change",".eulgetColumn",function(){
			...
			$.ajax({
				...
				url : base_url+"admin/tasks/getDatatypeconditions",
				dataType : 'json',
				data : {column : column,table:"tbl_touts","onchangeColref":"updateonchangeoperator",uopid:uopid},
				success : function(data){
