...
//				console.log(data);
		...
		$('input[name="conditionalrule"]')[0].checked = false;
			...
			$.ajax({
				...
				type : "post",
				data : {table:"tbl_adjustments",column:field,ref:1,condref:"conditions"},
				dataType : 'json',
	...
	// when condition script starts
		...
		$(document).on("change",".valConLabels",function(){
			...
			$.ajax({
				...
				dataType : 'json',
				data : {column : column,table:"tbl_adjustments","onchangeColref":"onchangecrulesCondition","uopid":uopid,"rCount":rCount},
				success : function(data){
...
//					console.log(data);
		...
		$(document).on("change",".ucvalLabels",function(){
			...
			$.ajax({
				...
				url : base_url+"admin/Conditions/getDatatypeconditions",
				dataType : 'json',
				data : {column : column,table:"tbl_adjustments","onchangeColref":"vcoperatorCh","uopid":uopid,"rCount":rCount},
				success : function(data){
			...
			$(document).on("click",'.addClabels',function(){
				...
				if(x < maxField){
					...
					$.ajax({
						...
						type : "post",
						data : {table:"tbl_adjustments",condref:"conditions"},
						dataType : 'json',
						url : base_url+"admin/tasks/getColumns",
						success : function(data){
//							console.log(data)
...
//				x++;
				...
				$.ajax({
					...
					type : "post",
					data : {table:"tbl_adjustments",column:field,ref:key,condref:"conditions"},
					dataType : 'json',
					url : base_url+"admin/tasks/getColumns",
					success : function(data){
...
//					console.log(data);
	...
	$(document).on("change",".changeCLabelArule",function(){
		...
		$.ajax({
			...
			url : base_url+"admin/Conditions/getDatatypeconditions",
			dataType : 'json',
			data : {column : column,table:"tbl_adjustments","onchangeColref":"changeOperatorCrule","uopid":uopid,"rCount":rCount},
			success : function(data){
	...
	$(document).on("change",".getConditionalLabels",function(){
		...
		if(val == "to a field value"){
			...
			$.ajax({
				...
				data : {table:"tbl_adjustments","rcount":rcount},
	//			dataType : 'json',
				success : function(data){
			...
			$.ajax({
				...
				type : "post",
				data : {table:"tbl_adjustments",column:field,ref:rcount,condref:"conditions"},
				dataType : 'json',
				url : base_url+"admin/tasks/getColumns",
				success : function(data){
