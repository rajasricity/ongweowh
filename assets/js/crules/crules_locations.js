	...
	if(vrid != ""){
		...
		$('input[name="conditionalrule"]')[0].checked = false;
			...
			$.ajax({
				...
				type : "post",
				data : {table:"tbl_locations",column:field,ref:1},
				dataType : 'json',
	...
	// when condition script starts
		...
		$(document).on("change",".valConLabels",function(){
			...
			$.ajax({
				...
				dataType : 'json',
				data : {column : column,table:"tbl_locations","onchangeColref":"onchangecrulesCondition","uopid":uopid,"rCount":rCount},
				success : function(data){
...
//					console.log(data);
		...
		$(document).on("change",".ucvalLabels",function(){
			...
			$.ajax({
				...
				url : base_url+"admin/Conditions/getDatatypeconditions",
				dataType : 'json',
				data : {column : column,table:"tbl_locations","onchangeColref":"vcoperatorCh","uopid":uopid,"rCount":rCount},
				success : function(data){
...
//				x++;
				...
				$.ajax({
					...
					type : "post",
					data : {table:"tbl_locations",column:field,ref:key},
					dataType : 'json',
					url : base_url+"admin/tasks/getColumns",
					success : function(data){
...
//					console.log(data);
	...
	$(document).on("change",".changeCLabelArule",function(){
		...
		$.ajax({
			...
			url : base_url+"admin/Conditions/getDatatypeconditions",
			dataType : 'json',
			data : {column : column,table:"tbl_locations","onchangeColref":"changeOperatorCrule","uopid":uopid,"rCount":rCount},
			success : function(data){
	...
	$(document).on("change",".getConditionalLabels",function(){
		...
		if(val == "to a field value"){
			...
			$.ajax({
				...
				data : {table:"tbl_locations","rcount":rcount},
	//			dataType : 'json',
				success : function(data){
			...
			$.ajax({
				...
				type : "post",
				data : {table:"tbl_locations",column:field,ref:rcount},
				dataType : 'json',
				url : base_url+"admin/tasks/getColumns",
				success : function(data){
